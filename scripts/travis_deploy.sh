...
if [[ "${TRAVIS_PULL_REQUEST}" != "false" || "${TRAVIS_REPO_SLUG}" != "hgscott/alteromonas-model" ]]; then
...
echo "Your new report will be visible at https://hgscott.github.io/alteromonas-model in a moment."
